...
//     }
//
//     std::optional<int> ConstantFolding::evaluate_unary(const token_t op, const int value) {
//         switch (op) {
//         case token_t::Minus:
//             return -value;
//         case token_t::Tilde:
...
//
//     std::optional<int>
//     ConstantFolding::evaluate_binary(const token_t op, const int left, const int right) {
//         switch (op) {
//         case token_t::Plus:
//             return left + right;
//         case token_t::Minus:
