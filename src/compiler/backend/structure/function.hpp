...
namespace compiler {
    ...
    public:
        ...
        explicit Function(std::string function_name): name_(std::move(function_name)) { }
        ...
        [[nodiscard]] std::vector<std::string>& params() {
            return params_;
        }
        ...
        [[nodiscard]] std::span<const InstrType> instructions_span() const {
            return instructions_;
        }
